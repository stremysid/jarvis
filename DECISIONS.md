...
A model-inferred staged memory requires the same durable tap on both channels. On a call, the spoken reply points Sid to `/decisions` in Telegram; spoken yes is not equivalent to that tap. The earlier sentence claiming it was equivalent was builder-written and was not a decision Sid approved. An affirmative reply may still ground an owner-stated fact against Jarvis's exact preceding question. Tier 3 retains #159's claim-before-body, expiring single use and no refund on failure; the separate PIN rebuild owns spoken PINs. No channel gets an exemption.
