...
| Verify an owner-reported deadline after the deadline tool PR is reviewed and deployed | Live acceptance needs your Telegram conversation: state the course, title, full date including year and time, then check the dated receipt and the next digest. No new migration is required by this tool | **not started; after deployment** |
