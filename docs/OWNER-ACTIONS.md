...
|---|---|---|
| **Load and pair the D2L collector on the PC and laptop** | Follow [the collector runbook](runbooks/d2l-extension.md), approve each device code in Telegram, enter the Durham hop once, check both hosts and run Test background read with D2L tabs closed. The shape probe results were supplied on 2026-09-23; do not ask for that probe again | **awaiting-owner**, only after independent review and resolution of the [receiver contract blockers](research/2026-09-23-d2l-collector-contract-gaps.md); actual background access remains unverified |
