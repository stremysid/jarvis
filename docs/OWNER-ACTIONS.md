...
| Authorize the D2L receiver migration and deployment after reviews | The builder has not touched a real database or production. First resolve the 0040 collision with #159's assigned 0039, then use the owner rollout procedure | **not started** |
