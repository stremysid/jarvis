...
| Accept Telegram reminder delivery and cancellation after deployment | Ask Jarvis to schedule a study reminder, verify its stored time/words, observe one delivery after that instant outside quiet hours, and confirm a cancelled reminder never arrives. A failed/unconfirmed reminder may already have arrived; do not request an automatic replacement without checking | **not started; after migration and deployment** |
