...
|---|---|---|
| Owner tools | One `OWNER_TOOL_DEFINITIONS` catalogue: nine memory tools, school, university, study, two collector tools and three guided assignment tools | None |
