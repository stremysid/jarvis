...
As of 2026-09-25 evening: school rows 11–12 ([#204](https://github.com/stremysid/jarvis/pull/204))
and memory rows 6–9, 13 ([#206](https://github.com/stremysid/jarvis/pull/206)) are **removed,
merged**, not deployed; voice rows 1, 3, 4, 5 ([#207](https://github.com/stremysid/jarvis/pull/207))
are **built, open, awaiting review**; row 10 is explicitly **not removed** (see below). The audit
also continued past its original
