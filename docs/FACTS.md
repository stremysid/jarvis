...
| **Migration `0038` is applied and the gateway is deployed.** D1 is at `0038`; Worker `78cb6e98` (2026-09-21), watchdog `c940f9b7`. The memory rebuild is live rather than merged-and-inert | Applied and deployed 2026-09-20, verified by querying `d1_migrations` and `sqlite_schema` | 2026-09-20 | yes |
