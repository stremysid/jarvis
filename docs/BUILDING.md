...
|---|---|---|
| R0 Deploy what exists | GPT-5.6 Sol, high | Claude Opus 5, high |
| R1 Calling (v1.0) | GPT-5.6 Sol, high | **Claude Opus 5, max** |
| R2 Home node and memory | GPT-5.6 Sol, high | Claude Opus 5, high |
| R3 Hermes and PC control | GPT-5.6 Sol, high | Claude Opus 5, high |
| R4 St. Remy | **Claude Opus 5, max** | GPT-5.6 Sol, high |
| R5 Deadlines | GPT-5.6 Sol, high | Claude Opus 5, high |
| R6 Send on command, Siri | GPT-5.6 Sol, high | Claude Opus 5, high |
| R7 Profile and manager | GPT-5.6 Sol, high | Claude Opus 5, high |
| R8 Errands, Tesla, wake word | GPT-5.6 Sol, high | Claude Opus 5, high |
| R9 Dashboard, voice notes | GPT-5.6 Sol, high | Claude Opus 5, high |
| R10 Later | GPT-5.6 Sol, high | Claude Opus 5, high |
