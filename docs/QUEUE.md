...
| CHANNEL-CONTINUITY-TRANSCRIPT: voice assistant replies are absent from the cross-channel timeline | **not started; follow-up to #174** | After #174 review and coordination with voice streaming, admit settled voice assistant replies to the common principal timeline with explicit assistant/owner roles and source channels. Update recent-history validation, D1/R2 literal history, meaning-history ingestion and suppression together; backfill under separately authorized migration/index work if needed. Prove Telegram → voice → Telegram continuation of both speakers, including DO eviction, interrupted/unsent replies, forgotten source turns, other-principal isolation and overlapping sessions. Do not weaken confirmation authority: model-inferred memory still requires the shared Telegram tap, while an owner-stated fact may be grounded only in the exact preceding question on that call | next continuity builder | cross-channel continuity |
