...
class FactRepository:
    ...
    @classmethod
    def open(cls, path: Path, *, now: str | None = None, store_root: Path | None = None) -> FactRepository:
        return cls(MemoryDatabase.open(Path(path), now=now or utc_now_iso(), store_root=store_root))
