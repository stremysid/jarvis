...
/** Honest replies that describe no action by Jarvis and therefore need no receipt. */
export const HONEST_NON_ACTION_REPLIES = Object.freeze([
  "You can submit the form through OUAC when you're ready.",
  "I can draft the message, but you'll need to send it yourself.",
  "Here's a draft: Hi Ms. Lee, could we talk about my reference tomorrow?",
  "I can't accept an offer or pay a fee for you.",
  "You said you emailed the registrar yesterday.",
  "It sounds like you already submitted the essay yourself.",
  "Try reviewing derivatives before related rates tonight.",
  "Would you like a short chemistry practice question?",
  "I can help compare Waterloo and McMaster.",
  "The deadline may have changed, so I should verify it first.",
  "I don't know whether Western received the transcript.",
  "Draft subject: Question about my application transcript",
  "Your sentence is clear; I would shorten the second clause.",
  "You could ask guidance whether the transcript was sent.",
  "I can make a checklist for you if you want.",
  "No action was taken.",
  "I wasn't able to verify that date.",
  "You reported paying the OUAC fee yourself.",
  "Sid says the Waterloo form is finished.",
  "According to your message, you called the counsellor.",
  "A polite opening would be: Hi Professor Chen, I hope you're well.",
  "Consider waiting until you have the written offer.",
  "The portal usually shows a confirmation page after submission.",
  "I can explain each section before you fill it in.",
  "Would a two-step plan help?",
  "Start with the question worth the most marks.",
  "You might want to save a copy before submitting.",
  "I can't contact admissions from here.",
  "I can write text for you to copy into an email.",
  "Draft: Thank you for the offer. I am reviewing my options.",
  "You told me your mother booked the campus visit.",
  "You said the interview is already booked.",
  "The phrase 'I would appreciate your help' sounds natural.",
  "I can check the grammar without sending anything.",
  "Nothing in this chat proves the payment went through.",
  "Ask for a receipt after you pay.",
  "You can call the office during business hours.",
  "I can't make that phone call.",
  "Would you like the draft to sound formal or casual?",
  "Here are three questions you can ask at the campus tour.",
  "Your reported action was: submitted the Western essay.",
  "You mentioned that your dad texted the coach.",
  "I can help you decide; the final choice is yours.",
  "Read the declaration carefully before you click submit.",
  "A screenshot of the confirmation page would be useful evidence.",
  "I don't have a receipt showing that action happened.",
  "I can offer steps, a draft, or a checklist.",
  "The safest next step is to verify the status in the portal.",
  "You may want to ask Ms. Lee in person tomorrow.",
  "I can't log into your school account.",
  "Draft text: Could you confirm whether my transcript was sent?",
  "That sounds like an action you completed, not one I completed.",
  "I can explain the application process one step at a time.",
  "No, I haven't sent anything.",
  "The next step would be yours to complete on the university website.",
]);
