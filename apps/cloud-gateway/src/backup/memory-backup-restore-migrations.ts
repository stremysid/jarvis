...
import migration0040 from "../persistence/migrations/0040_tool_confirmation_consumptions.sql";
...
export const MEMORY_BACKUP_RESTORE_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({ name: "0040_tool_confirmation_consumptions.sql", sql: migration0040 }),
]);
