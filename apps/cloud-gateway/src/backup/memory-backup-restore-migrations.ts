...
import migration0053 from "../persistence/migrations/0053_deadline_effort_judgment.sql";
...
export const MEMORY_BACKUP_RESTORE_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({ name: "0053_deadline_effort_judgment.sql", sql: migration0053 }),
]);
