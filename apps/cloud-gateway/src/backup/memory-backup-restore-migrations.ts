...
import migration0047 from "../persistence/migrations/0047_note_sources_without_markdown_citation.sql";
...
export const MEMORY_BACKUP_RESTORE_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({ name: "0047_note_sources_without_markdown_citation.sql", sql: migration0047 }),
]);
