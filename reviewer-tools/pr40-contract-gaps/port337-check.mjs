// Applies one hand-ported PR33 gap onto the PR #40 fix head (337c290). Gap 1 re-anchored on #guardOwnerRepeat. Exact-anchor replacements only;
// every anchor must occur exactly once or nothing is written.
import { readFileSync, writeFileSync } from "node:fs";

const ROOT = "C:/Users/Sid/AppData/Local/Temp/claude/C--javis--claude-worktrees-jarvis-code-review-0b1695/94258c1b-4724-43a5-acec-ad80dad58bf4/scratchpad/prep/pr40-contract-gaps/check337/";
