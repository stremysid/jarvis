...
- #39 round-3 at 8b62e80: CHANGES REQUESTED. pnpm 2886/2886, pytest 878/32, H2 probe still fails (fixed), trigger removal 75/75 genuine (65 named + 10 hand-checked). Re-verify2: 9 fixed/3 partial; NF1 High (implicit rowid REPLACE on 17 TEXT-PK tables) runtime-confirmed by pr39-nf1-probe.test.ts; NF2 topic sibling REPLACE, NF3 rules future-dated expiry, L4 ledger future occurred_at. Recommend WITHOUT ROWID + generic REPLACE sweep test. killcheck.mjs classifies kills (named/other/timeouts).
